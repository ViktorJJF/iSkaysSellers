            ...
            <div class="row no-gutters">
              ...
              <div class="col-6 pr-2 border-right">
                <div class="display-1 font-weight-500 mb-3">
                  $19
                  <span class="d-inline-block f-14">/month</span>
                </div>
              ...
              <div class="col-6 text-center">
                ...
                <div class="mb-3">
                  <a
                    ...
                    class="btn btn-secondary btn-xs text-uppercase"
                  >Renew Plan</a>
                </div>
        ...
        <div class="dt-card">
          ...
          <div class="dt-card__body p-6">
            ...
            <div class="media mb-3">
              <!-- Avatar -->
              <img class="img-fluid mr-6" src="assets/images/widget/home-logo.jpg" alt="project" />
              <!-- /avatar -->
            ...
            <!-- Card text -->
            <p>
              Structure sales Pvt. Ltd is boston’s reputed government
              construction company since 2011.
            </p>
            <!-- /card text -->
          ...
          <div class="dt-card__header mb-0">
            ...
            <div class="dt-card__tools align-self-start">
              ...
              <span class="dt-card__more font-weight-normal">
                <span class="dot-shape bg-primary mr-2"></span>Closed
                Deals
              </span>
            </div>
            <!-- /card tools -->
              ...
              <ul class="dt-list dt-list-xxl dt-list-bordered flex-nowrap">
                ...
                <li class="dt-list__item text-center col">
                  <div class="dt-avatar-wrapper flex-column">
                    <!-- Image -->
                    <img
                      src="assets/images/user-avatar/noah-owens.jpg"
                      alt="Noah Owens"
                ...
                <li class="dt-list__item text-center col">
                  <div class="dt-avatar-wrapper flex-column">
                    <!-- Image -->
                    <img
                      src="assets/images/user-avatar/ellen-manning.jpg"
                      alt="Ellen Manning"
                      class="dt-avatar mb-4 size-80"
                    />
                    <!-- /image -->
                ...
                <li class="dt-list__item text-center col">
                  <div class="dt-avatar-wrapper flex-column">
                    <!-- Image -->
                    <img
                      src="assets/images/user-avatar/jones.jpg"
                      alt="Angel Jones"
                      class="dt-avatar mb-4 size-80"
                    />
                    <!-- /image -->
                ...
                <li class="dt-list__item text-center col">
                  <div class="dt-avatar-wrapper flex-column">
                    <!-- Image -->
                    <img
                      src="assets/images/user-avatar/mila-alba.jpg"
                      alt="Mila Alba"
                      class="dt-avatar mb-4 size-80"
                    />
                    <!-- /image -->
          ...
          <div class="col-xl-12">
            ...
            <div class="card">
              ...
              <div class="card-header card-nav border-bottom-0">
                ...
                <ul
                  class="card-header-tabs nav nav-tabs nav-tabs-sm nav-scroll mx-0"
                  role="tablist"
                >
                  <li class="nav-item">
                    <a
                  ...
                  <div class="card-body">
                    ...
                    <div class="card shadow-none horizontal rounded-0 pb-8 border-bottom">
                      ...
                      <div class="dt-slider rounded-xl overflow-hidden order-sm-2">
                          ...
                          <div class="dt-checkbox dt-checkbox-icon dt-checkbox-only">
                            ...
                            <label class="font-weight-light dt-checkbox-content" for="checkbox-1">
                              <span class="unchecked">
                                <i class="icon icon-heart-o text-white"></i>
                              </span>
                              <span class="checked">
                                <i class="icon icon-heart text-white"></i>
                              </span>
                            </label>
                          </div>
                          <!-- /checkbox -->
                        ...
                        <div class="owl-carousel owl-theme">
                          <img src="assets/images/grid/property-6.jpg" alt="Property" />
                          <img src="assets/images/grid/living-room-6.jpg" alt="Living Room" />
                          <img src="assets/images/grid/bedroom-6.jpg" alt="Bedroom" />
                        </div>
                      </div>
                      <!-- /slider -->
                      ...
                      <div class="card-stacked order-sm-1">
                        ...
                        <div class="card-body pt-sm-0 pb-0 px-0 pr-sm-6 pr-md-8">
                          ...
                          <!-- Card Title-->
                          <h3
                            class="card-title font-weight-normal text-truncate"
                          >Luxury family home at beach side</h3>
                          <!-- Card Title-->
                          ...
                          <div class="d-flex align-items-baseline price mb-1">
                            <span
                              class="d-block text-primary font-weight-500 display-5 mr-1"
                            >$670,500</span>
                    ...
                    <div class="card shadow-none horizontal rounded-0 pb-8 border-bottom">
                      ...
                      <div class="dt-slider rounded-xl overflow-hidden order-sm-2">
                        ...
                        <!-- Carousel -->
                        <div class="owl-carousel owl-theme">
                          <img src="assets/images/grid/property-5.jpg" alt="Property" />
                          <img src="assets/images/grid/living-room-5.jpg" alt="Living Room" />
                          <img src="assets/images/grid/bedroom-5.jpg" alt="Bedroom" />
                        </div>
                        <!-- /carousel -->
                      </div>
                      <!-- /slider -->
                    ...
                    <div class="card shadow-none horizontal mb-0">
                      ...
                      <div class="dt-slider rounded-xl overflow-hidden order-sm-2">
                        ...
                        <!-- Carousel -->
                        <div class="owl-carousel owl-theme">
                          <img src="assets/images/grid/property-7.jpg" alt="Property" />
                          <img src="assets/images/grid/living-room-7.jpg" alt="Living Room" />
                          <img src="assets/images/grid/bedroom-7.jpg" alt="Bedroom" />
                        </div>
                        <!-- /carousel -->
                      </div>
                      <!-- /slider -->
          ...
          <div class="dt-card__body px-0">
            ...
            <div class="dt-widget dt-widget-hover">
              ...
              <div class="dt-widget__item">
                ...
                <div class="dt-widget__img">
                  <!-- Avatar -->
                  <img
                    class="dt-avatar size-35 rounded"
                    src="assets/images/user-avatar/nikki.jpg"
                    alt="User"
                  />
                  <!-- /avatar -->
                ...
                <div class="dt-widget__info">
                  <a href="javascript:void(0)" class="dt-widget__title">
                    Mila Alba left a 5 star review on Albama’s
                    House
                  </a>
                </div>
                <!-- /widget info -->
              ...
              <div class="dt-widget__item">
                ...
                <div class="dt-widget__info">
                  <a href="javascript:void(0)" class="dt-widget__title">
                    Callback request from Bob Builder for the
                    property Dimitri House
                  </a>
                </div>
                <!-- /widget info -->
              </div>
              ...
              <div class="dt-widget__item">
                ...
                <div class="dt-widget__info">
                  <a href="javascript:void(0)" class="dt-widget__title">
                    Congratulations to Tom Moody for joining 10+
                    club
                  </a>
                </div>
                <!-- /widget info -->
              ...
              <div class="dt-widget__item">
                ...
                <div class="dt-widget__info">
                  <a href="javascript:void(0)" class="dt-widget__title">
                    Norman Dolphi is looking for a house in New
                    Jersy, USA
                  </a>
                </div>
                <!-- /widget info -->
            ...
            <div class="dt-widget dt-widget-hover">
              ...
              <div class="dt-widget__item">
                ...
                <div class="dt-widget__info">
                  <a href="javascript:void(0)" class="dt-widget__title">
                    Agent Kily Johns has added 7 new photos to the
                    property Albama’s House
                  </a>
                </div>
                <!-- /widget info -->
              </div>
              ...
              <div class="dt-widget__item">
                ...
                <div class="dt-widget__info">
                  <a
                    href="javascript:void(0)"
                    class="dt-widget__title"
                  >Welcome to a new agent Tom Moody in the Company</a>
                  <ul class="dt-team-list mt-2">
                    <li>
                      <!-- Avatar -->
                      <a class="dt-avatar size-35 min-w-55 rounded" href="javascript:void(0)">
                        <img class="img-fluid" src="assets/images/card/beach.jpg" alt="Beach" />
                      </a>
                      <!-- /avatar -->
                    </li>
                    <li>
                      <!-- Avatar -->
                      <a class="dt-avatar size-35 min-w-55 rounded" href="javascript:void(0)">
                        <img class="img-fluid" src="assets/images/card/sunset.jpg" alt="Sunset" />
                      </a>
                      <!-- /avatar -->
                    </li>
                    <li>
                      <!-- Avatar -->
                      <a
                        class="border py-2 px-4 rounded text-light-gray d-inline-block"
                        href="javascript:void(0)"
                      >+5 More</a>
                      <!-- /avatar -->
                    </li>
              ...
              <div class="dt-widget__item">
                ...
                <div class="dt-widget__info">
                  <a href="javascript:void(0)" class="dt-widget__title">
                    Oliver Shorter is looking for an office space in
                    Colorado, USA
                  </a>
                </div>
                <!-- /widget info -->
