        ...
        <span class="dt-brand__logo">
          <a class="dt-brand__logo-link" href="index-2.html">
            <img
              ...
              src="assets/images/logo/iSkaysLogo.png"
              alt="iSkays"
              width="600px"
            />
          </a>
                  ...
                  <div class="h-auto">
                    ...
                    <a href="javascript:void(0)" class="media">
                      ...
                      <span class="action-area h-100 min-w-80 text-right">
                        ...
                        >
                          <span class="show">
                            <i class="icon icon-dot-o icon-fw f-10 text-light-gray"></i>
                          </span>
                          <span class="hide">
                            <i class="icon icon-dot icon-fw f-10 text-light-gray"></i>
                          </span>
                        </span>
                        <!-- /toggle button -->
                      </span>
...
export default {
  computed: {
    fullname() {
      return (
        this.$store.state.authModule.user.first_name +
        " " +
        this.$store.state.authModule.user.last_name
      );
    },
  },
};
